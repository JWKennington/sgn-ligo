...
def parse_command_line():
    ...
    parser.add_option("--wait-time", metavar = "seconds", type = int, help = "Time to wait for new files in seconds before throwing an error. In online mode, new files should always arrive every second, unless there are problems. Default wait time is 60 seconds.")
