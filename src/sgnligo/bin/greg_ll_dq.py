...
from sgnligo.sinks import FakeSeriesSink
...
def parse_command_line():
    ...
    # add our own options
    parser.add_option("--sample-rate", metavar = "Hz", default = 2048, type = "int", help = "Sample rate at which to generate the PSD, default 2048 Hz")
